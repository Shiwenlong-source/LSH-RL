...
class RolloutLegacy(BaseModel):
    ...
    # Per-triplet rewards (optional, for fine-grained reward assignment)
    triplet_rewards: Optional[List[Optional[float]]] = Field(
        default=None,
        description="List of rewards corresponding to each triplet. "
        "Allows different rewards for different triplets within the same rollout.",
    )
